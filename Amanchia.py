...
def scenario_base(data):
    sto = data['storage']
    #sto.loc[('Amanchia', 'Battery'), 'cap-up-c'] = 0
    #sto.loc[('Amanchia', 'Biogas Storage'), 'cap-up-c'] = 0
    #sto.loc[('Amanchia', 'Wheat Storage'), 'cap-up-c'] = 0
    #sto.loc[('Amanchia', 'Water Tank'), 'cap-up-c'] = 0
    #sto.loc[('Amanchia', 'Biogas Equivalent Storage'), 'cap-up-c'] = 0
    #sto.loc[('Amanchia', 'Biogas Equivalent Storage'), 'cap-up-c'] = 0
    pro = data['process']
    #pro.loc[('Amanchia', 'Photovoltaics'), 'cap-up'] = 0
    #pro.loc[('Amanchia', 'Diesel Generator'), 'cap-up']=0
    #pro.loc[('Amanchia', 'Water Pump'), 'cap-up']=0
    #pro.loc[('Amanchia', 'WheatBuy to Wheat'),'cap-up']=0
    #pro.loc[('Amanchia', 'Wheat Field'), 'cap-up']=0
    #pro.loc[('Amanchia', 'Wheat to WheatSell'),'cap-up']=0
    #pro.loc[('Amanchia', 'Water to Irrigation Water'), 'cap-up']=0
    #pro.loc[('Amanchia', 'Wheat to Biogas Equivalent'), 'cap-up']=0
    #pro.loc[('Amanchia', 'Biogas Generator'), 'cap-up']=0
    #pro.loc[('Amanchia', 'Biogas Digester'), 'cap-up']=0
    return data
...
if __name__ == '__main__':
    ...
    shutil.copyfile(__file__, os.path.join(result_dir, 'Amanchia.py'))
    ...
    plot_tuples = [
       ...
       # ('Amanchia', 'Wheat'),
       # ('Amanchia', 'WheatBuy'),
       # ('Amanchia', 'Irrigation Water'),
       # ('Amanchia', 'Wheat Waste'),
       # ('Amanchia', 'WheatSell'),
       # ('Amanchia', 'Biogas Equivalent'),
       # ('Amanchia', 'Biogas'),
       # ('Amanchia', 'Rain'),
       ]
