...
def scenario_base(data):
    ...
    pro.loc[('StRupertMayer', 'Rain to Irrigation Water'), 'cap-up']=0
    pro.loc[('StRupertMayer', 'Tomato Waste to Biogas Equivalent'), 'cap-up']=0
...
if __name__ == '__main__':
    ...
    shutil.copyfile(__file__, os.path.join(result_dir, 'runme_TEWF_R.py'))
    ...
    my_colors = {
        ...
        'Shunt(Waste)':(171,143,110),
        'Tomato to TomatoSell':(121,31,34),
        'Tomato Waste to Biogas Equivalent':(130,105,75),
        'Tomato to Biogas Equivalent':(118,68,90),
        'Rain to Irrigation Water':(109,206,221),
        }
