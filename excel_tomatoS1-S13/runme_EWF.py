...
if __name__ == '__main__':
    ...
    shutil.copyfile(__file__, os.path.join(result_dir, 'runme_EWF.py'))
    ...
    my_colors = {
        ...
        'Water to Irrigation Water':(36,91,140),
        ...
        'Shunt(Biogas Equivalent)':(171,143,110),
